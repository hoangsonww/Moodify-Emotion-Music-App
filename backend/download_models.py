...
model_files = {
    ...
    "speech_emotion_model_scaler": {
        "url": "https://drive.google.com/uc?id=1cd2m7NIsWfgIPs8jU7C2cB7M0QQY_u_l",  # Speech Emotion Detection Model (scaler.pkl)
        "output": os.path.join(BASE_DIR, "ai_ml/models/speech_emotion_model/scaler.pkl"),
    },
    "speech_emotion_model": {
        "url": "https://drive.google.com/uc?id=1MPfkTkWjmjsVVs-cjkav48Mn8NUmVCG9",  # Speech Emotion Detection Model (trained_speech_emotion_model.pkl)

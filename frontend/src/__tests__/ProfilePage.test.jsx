...
describe('<ProfilePage />', () => {
  ...
  it('shows loading then renders profile info, mood and rec history', async () => {
    ...
    expect(screen.getByText(/Your Email: test@example\.com/i)).toBeInTheDocument()
  ...
  it('shows error message if fetch fails and no cache', async () => {
    ...
    expect(await screen.findByText(/Failed to fetch profile data/i)).toBeInTheDocument()
  })
})

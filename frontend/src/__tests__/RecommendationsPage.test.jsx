...
describe('<RecommendationsPage />', () => {
  ...
  it('renders the main heading and description', () => {
    ...
    expect(
      screen.getByText(/Here are some music recommendations based on your mood:/i)
    ).toBeInTheDocument()
  })

  it('renders three track cards with titles and artists', () => {
    // Track titles
    expect(screen.getByRole('heading', { level: 3, name: /Track 1/i })).toBeInTheDocument()
    expect(screen.getByRole('heading', { level: 3, name: /Track 2/i })).toBeInTheDocument()
    expect(screen.getByRole('heading', { level: 3, name: /Track 3/i })).toBeInTheDocument()
